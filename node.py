...
# broadcasts the block to connected nodes
...
# shows and processes the transactions for the blocks
...
# collects the transactions and a dict of the GET parameters
